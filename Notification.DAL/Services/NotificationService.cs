...
namespace Notification.DAL.Services
{
    public class NotificationService : INotificationService
    {
        ...
        private readonly MyContext _notificationContext;
        private readonly IHubContext<NotificationHub> _hubContext;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public NotificationService(
            ILogger<NotificationService> logger,
            MyContext notificationContext,
        ...
        //        {
        //            var header = eventObj.Template.TemplateHeader;
        //            var content = string.Format(eventObj.Template.TemplateContent, new object?[]
        //            {
        //                //user.FullName,
        //                //url,
        //                //GetDate.ToString("s")
